// Colors
// export const redPink = '#ff5757'
// export const purpleBlue = '#343578'
// export const green = '#1a967c'
// export const gray = '#e3eef0'
...
export const mobileSize = '@media (min-width: 250px) and (max-width: 738px)'
